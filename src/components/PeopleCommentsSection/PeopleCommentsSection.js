import "./PeopleCommentsSection.css";

const PeopleCommentsSection = () => {
  return (
    <div className="what-do-people-say-parent">
      <div className="what-do-people">What do people say</div>
      <div className="frame-parent4">
        <div className="frame-parent5">
          ...
          <div className="frame-parent6">
            ...
            <div className="marinello-j">Marinello J.</div>
          </div>
        </div>
        <div className="frame-parent9">
          ...
          <div className="frame-parent6">
            ...
            <div className="samantha-r">Samantha R.</div>
          </div>
        </div>
      </div>
    </div>
...
export default PeopleCommentsSection;
